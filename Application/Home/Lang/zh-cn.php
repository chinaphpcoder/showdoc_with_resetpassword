...
return array(
    ...
    'reset_password'=>'重置密码',
    'bind_email'=>'绑定的邮箱',
    'bind_email_description'=>'请输入要绑定的邮箱地址',
    'password_description'=>'请输入你的登录密码',
    'update_personal_password'=>'修改密码',
    'update_personal_email'=>'我的邮箱',
    'update_personal_email_submit'=>'修改邮箱',
    'reset_password_new_password'=>'请输入新密码',

    'url_had_expired'=>'链接已失效',

    //message 弹出信息有关的文案
    'no_permissions'=>'你无权限',
    'incorrect_password'=>'密码错误',
    'user_does_not_exist'=>'不存在此用户',
    'email_does_not_exist'=>'无此邮箱或此邮箱未经验证',
